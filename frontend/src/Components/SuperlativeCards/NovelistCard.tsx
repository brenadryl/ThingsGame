...
interface NovelistCardProps {
  player: Player;
}

const NovelistCard: React.FC<NovelistCardProps> = ({ player }) => {
  ...
  return (
      <Box marginY="8px">
          <Box sx={{ position: 'relative', display: 'inline-block' }} marginY="12px">
            ...
            >
                { isDisplayed && 
                <img src={SUPERLATIVES.novelist} alt="novelist" width={100} />
                }
            </Box>
        </Box>
