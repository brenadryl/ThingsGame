...
interface BrevityCardProps {
    player: Player;
}

const BrevityCard: React.FC<BrevityCardProps> = ({ player }) => {
  ...
  return (
      <Box marginY="8px">
        <Box sx={{ position: 'relative', display: 'inline-block' }} marginY="12px">
            ...
            >
                { isDisplayed && 
                    <img src={SUPERLATIVES.brevity} alt="brevity" width={140} />
                }
            </Box>
        </Box>
